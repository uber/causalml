...
CONTROL_NAME = 'c'
TREATMENT_NAMES = [CONTROL_NAME, 't1', 't2', 't3']
...
def test_UpliftRandomForestClassifier(generate_data):
    ...
    uplift_model = UpliftRandomForestClassifier(control_name=TREATMENT_NAMES[0])
    ...
    cumgain = get_cumgain(auuc_metrics, outcome_col=CONVERSION, treatment_col='is_treated')

    # Check if the cumulative gain of UpLift Random Forest is higher than random
